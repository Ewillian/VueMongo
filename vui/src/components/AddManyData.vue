<template>
  <div class="container">
    ...
    <h2>{{collectionName}}</h2>
      ...
      <label for="input-file">Fichier à importer :</label><br><br>
    ...
    <div id="byte_content"></div>
      ...
      <router-link :to="{ name: 'InsertManyData', params: {collectionName, fileContent}}"><button id='send' type='submit' @click="handleJsonFile()">Envoyer</button></router-link>
